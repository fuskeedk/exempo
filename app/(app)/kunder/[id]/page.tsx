...
import { MailLink, MapButton, PhoneLink } from "@/components/ContactActions";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={
          <>
            {customer.phone ? <PhoneLink phone={customer.phone} className="hover:underline" /> : null}
            {customer.phone && customer.email ? " · " : null}
            {customer.email ? <MailLink email={customer.email} className="hover:underline" /> : null}
          </>
        }
      />
